...
func (UserStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_userapi_v1_user_proto_enumTypes[0].Descriptor()
}

func (UserStatus) Type() protoreflect.EnumType {
	return &file_userapi_v1_user_proto_enumTypes[0]
}
...
type User struct {
	...
	Status    UserStatus `protobuf:"varint,8,opt,name=status,proto3,enum=userapi.v1.UserStatus" json:"status,omitempty"`
...
var file_userapi_v1_user_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x31, 0x1a, 0x15, 0x75, 0x73, 0x65, 0x72, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x2f,
	0x6d, 0x65, 0x74, 0x61, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1f, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x5f, 0x62, 0x65, 0x68,
	0x61, 0x76, 0x69, 0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x96, 0x02, 0x0a, 0x04,
	...
	0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x2e,
	...
	0x0a, 0x04, 0x6d, 0x65, 0x74, 0x61, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x75,
	0x73, 0x65, 0x72, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x65, 0x74, 0x61, 0x52, 0x04,
	0x6d, 0x65, 0x74, 0x61, 0x2a, 0x5b, 0x0a, 0x0a, 0x55, 0x73, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74,
	...
	0x6e, 0x73, 0x61, 0x6c, 0x74, 0x75, 0x6e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2f, 0x75,
	0x73, 0x65, 0x72, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x3b, 0x75, 0x73, 0x65, 0x72, 0x61, 0x70,
...
var file_userapi_v1_user_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_userapi_v1_user_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_userapi_v1_user_proto_goTypes = []interface{}{
	(UserStatus)(0), // 0: userapi.v1.UserStatus
	(*User)(nil),    // 1: userapi.v1.User
	(*Meta)(nil),    // 2: userapi.v1.Meta
}
var file_userapi_v1_user_proto_depIdxs = []int32{
	0, // 0: userapi.v1.User.status:type_name -> userapi.v1.UserStatus
	2, // 1: userapi.v1.User.meta:type_name -> userapi.v1.Meta
...
func file_userapi_v1_user_proto_init() {
	...
	file_userapi_v1_meta_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_userapi_v1_user_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_userapi_v1_user_proto_enumTypes,
