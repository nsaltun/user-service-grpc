...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/nsaltun/user-service-grpc/proto/gen/go/user/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	UserAPIName = "userapi.user.v1.UserAPI"
)
...
const (
	...
	UserAPICreateUserProcedure = "/userapi.user.v1.UserAPI/CreateUser"
	// UserAPIUpdateUserByIdProcedure is the fully-qualified name of the UserAPI's UpdateUserById RPC.
	UserAPIUpdateUserByIdProcedure = "/userapi.user.v1.UserAPI/UpdateUserById"
	// UserAPIDeleteUserByIdProcedure is the fully-qualified name of the UserAPI's DeleteUserById RPC.
	UserAPIDeleteUserByIdProcedure = "/userapi.user.v1.UserAPI/DeleteUserById"
	// UserAPIListUsersProcedure is the fully-qualified name of the UserAPI's ListUsers RPC.
	UserAPIListUsersProcedure = "/userapi.user.v1.UserAPI/ListUsers"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	userAPIServiceDescriptor              = v1.File_user_v1_userapi_proto.Services().ByName("UserAPI")
...
// UserAPIClient is a client for the userapi.user.v1.UserAPI service.
...
// NewUserAPIClient constructs a client for the userapi.user.v1.UserAPI service. By default, it uses
...
// CreateUser calls userapi.user.v1.UserAPI.CreateUser.
...
// UpdateUserById calls userapi.user.v1.UserAPI.UpdateUserById.
...
// DeleteUserById calls userapi.user.v1.UserAPI.DeleteUserById.
...
// ListUsers calls userapi.user.v1.UserAPI.ListUsers.
...
// UserAPIHandler is an implementation of the userapi.user.v1.UserAPI service.
...
func NewUserAPIHandler(svc UserAPIHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/userapi.user.v1.UserAPI/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUserAPIHandler) CreateUser(context.Context, *connect.Request[v1.CreateUserRequest]) (*connect.Response[v1.CreateUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("userapi.user.v1.UserAPI.CreateUser is not implemented"))
}
...
func (UnimplementedUserAPIHandler) UpdateUserById(context.Context, *connect.Request[v1.UpdateUserByIdRequest]) (*connect.Response[v1.UpdateUserByIdResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("userapi.user.v1.UserAPI.UpdateUserById is not implemented"))
}
...
func (UnimplementedUserAPIHandler) DeleteUserById(context.Context, *connect.Request[v1.DeleteUserByIdRequest]) (*connect.Response[v1.DeleteUserByIdResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("userapi.user.v1.UserAPI.DeleteUserById is not implemented"))
}
...
func (UnimplementedUserAPIHandler) ListUsers(context.Context, *connect.Request[v1.ListUsersRequest]) (*connect.Response[v1.ListUsersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("userapi.user.v1.UserAPI.ListUsers is not implemented"))
}
